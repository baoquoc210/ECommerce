          ...
          <div className="footer flex px-3 lg:px-0 flex-col lg:flex-row py-8">
            <div className="part1 w-full lg:w-[25%] border-r border-[rgba(0,0,0,0.1)]">
              ...
              <p className="text-[13px] font-[400] pb-4">
                FinTech E-Commerce Shop
                <br />
                RMIT VietNam - Australia
              </p>

              <Link
                className="link text-[13px]"
                to="12quocbao@gmail.com"
              >
                12quocbao@gmail.com
              </Link>
        ...
        <div className="container flex items-center justify-between flex-col lg:flex-row gap-4 lg:gap-0">
          <ul className="flex items-center gap-2">
            <li className="list-none">
              <Link
                to="https://www.facebook.com/quocbao.huynh.7731?locale=vi_VN"
                target="_blank"
            ...
            <li className="list-none">
              <Link
                to="https://github.com/baoquoc210"
                target="_blank"
                className="w-[35px] h-[35px] rounded-full border border-[rgba(0,0,0,0.1)] flex items-center justify-center group hover:bg-primary transition-all"
              >
                <FaGithub className="text-[21px] group-hover:text-white" />
              </Link>
            </li>

            <li className="list-none">
              <Link
                to="https://www.hackerrank.com/profile/12quocbao"
                target="_blank"
                className="w-[35px] h-[35px] rounded-full border border-[rgba(0,0,0,0.1)] flex items-center justify-center group hover:bg-primary transition-all"
              >
                <FaHackerrank className="text-[17px] group-hover:text-white" />
              </Link>
            </li>

            <li className="list-none">
              <Link
                to="https://www.instagram.com/hh.hqb/"
                target="_blank"
                className="w-[35px] h-[35px] rounded-full border border-[rgba(0,0,0,0.1)] flex items-center justify-center group hover:bg-primary transition-all"
              >
